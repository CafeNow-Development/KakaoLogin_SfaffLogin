package com.login.cafenow_kakaologin_stafflogin.common.response.service;

import com.login.cafenow_kakaologin_stafflogin.common.response.domain.CommonResult;
import com.login.cafenow_kakaologin_stafflogin.common.response.domain.ListResult;
